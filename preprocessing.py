...
def preprocessing(work_dir='C:\\Users\\Haimin\\Dicom\\01'):
    os.chdir(work_dir)
...
def show_tags(im, work_dir='C:\\Users\\Haimin\\Dicom\\01'):
    os.chdir(work_dir)
    ds = pyd.dcmread(im)
...
def create_input(work_dir='C:\\Users\\Haimin\\Dicom\\01'):
    os.chdir(work_dir)
    array_list = list()
    for image in os.listdir(work_dir):
...
if __name__=="__main__":
    #os.chdir('C:\\Users\\Haimin\\Dicom\\01')
    #pixel_array('23')
    #image_downsampling('7')
    #ic.print_image('7')
    #preprocessing()
    #show_tags('24')
    create_input()
